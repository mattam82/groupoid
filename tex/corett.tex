...
(see \cite{DBLP:bibsonomy_cupart}, \S 2 for an in-depth study of this system). This is basically Martin-Löf Type Theory. First we introduce the definitions of the
...
The rules are entirely standard. The definitional equality $A = B$ is
