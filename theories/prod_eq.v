...
Ltac trunc_eq' := match goal with
         | [ |- [?e] @ ?t ~ [?e'] @ ?t] =>
           let H := fresh in
           assert (H:=@HoTT_light.center _ (Trunc_2 (T:=Type0) _ _ _ _ e e')) ;
...
Definition prod_eq_comp' (A: UGroupoidType) (T U V: [A --> _Type]) 
        (e:T ~1 U) (e' : U ~1 V) : 
...
simpl_id_bi. simpl_id_bi. apply identity.
Defined.

Definition prod_eq_id (A: UGroupoidType) (T: [A --> _Type]) 
...
Next Obligation. eapply composition. apply (prod_eq_comp (inverse e) e).
                 eapply composition; [idtac | apply prod_eq_id]. 
                 apply (@prod_eq_map _ _ _ (e ° e ^-1) (identity U)). 
                 intro. simpl. apply (equiv_inv_R _ _ (e @ t)). 
Defined.
Next Obligation. eapply composition. apply (prod_eq_comp e (inverse e)).
                 eapply composition; [idtac | apply prod_eq_id]. 
