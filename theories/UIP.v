...
Definition UIP_1 (Γ: Context) (A : Typ Γ)
           (a b: Elt A) (e e' : Elt (Id a b)):
  ∀ t : [Γ], [([[[Id e e']]]) @ t] := fun t => Trunc_1 _ _ _ _ _.

(*end hide*)

Definition UIP Γ (A:Typ Γ) (a b: Elt A) (e e' : Elt (Id a b)): Elt (Id e e').
(*begin hide*)
  exists (UIP_1 e e').
  refine (Build_DependentFunctor _ _ _ _ _ _).
  intros x y X. apply Trunc_1.
  intros; exact tt.
  intros; exact tt.
  intros; exact tt.
Defined.
